...
public class UserServiceIntTest {
    ...
    public void assertThatUserMustExistToResetPassword() {
        ...
        Optional<User> maybeUser = userService.requestPasswordReset("invalid.login@localhost", "login");
        assertThat(maybeUser).isNotPresent();

        maybeUser = userService.requestPasswordReset(user.getEmail(), user.getLogin());
    ...
    public void assertThatOnlyActivatedUserCanRequestPasswordReset() {
        ...
        Optional<User> maybeUser = userService.requestPasswordReset(user.getEmail(), user.getLogin());
        assertThat(maybeUser).isNotPresent();
