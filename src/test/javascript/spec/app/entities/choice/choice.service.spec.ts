...
describe('Service Tests', () => {
    describe('Choice Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ChoiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/choices';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Choice', () => {
                service.create(new Choice(null)).subscribe(received => {
            ...
            it('should update a Choice', () => {
                service.update(new Choice(123)).subscribe(received => {
