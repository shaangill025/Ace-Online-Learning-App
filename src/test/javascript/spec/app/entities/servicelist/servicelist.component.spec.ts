...
import { ServicelistComponent } from 'app/entities/servicelist/servicelist.component';
...
describe('Component Tests', () => {
    describe('Servicelist Management Component', () => {
        let comp: ServicelistComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ServicelistComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.servicelists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
