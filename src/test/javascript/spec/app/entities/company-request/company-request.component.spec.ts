...
import { CompanyRequestComponent } from 'app/entities/company-request/company-request.component';
...
describe('Component Tests', () => {
    describe('CompanyRequest Management Component', () => {
        let comp: CompanyRequestComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CompanyRequestComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.companyRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
