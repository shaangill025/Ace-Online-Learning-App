...
import { FileManagerComponent } from 'app/entities/file-manager/file-manager.component';
...
describe('Component Tests', () => {
    describe('FileManager Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.fileManagers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
