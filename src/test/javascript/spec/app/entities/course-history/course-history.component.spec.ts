...
import { CourseHistoryComponent } from 'app/entities/course-history/course-history.component';
...
describe('Component Tests', () => {
    describe('CourseHistory Management Component', () => {
        let comp: CourseHistoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CourseHistoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.courseHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
