...
import { SectionHistoryComponent } from 'app/entities/section-history/section-history.component';
...
describe('Component Tests', () => {
    describe('SectionHistory Management Component', () => {
        let comp: SectionHistoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SectionHistoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sectionHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
