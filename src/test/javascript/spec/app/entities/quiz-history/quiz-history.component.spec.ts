...
import { QuizHistoryComponent } from 'app/entities/quiz-history/quiz-history.component';
...
describe('Component Tests', () => {
    describe('QuizHistory Management Component', () => {
        let comp: QuizHistoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(QuizHistoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.quizHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
