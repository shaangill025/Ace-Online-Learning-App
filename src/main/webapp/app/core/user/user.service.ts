...
export class UserService {
    ...
    private resourceLoginUrl2 = SERVER_API_URL + 'api/users/username';
    ...
    getuserbylogin(parameter: string): Observable<number> {
        return this.http.get<number>(`${this.resourceLoginUrl2}/${parameter}`);
    }
